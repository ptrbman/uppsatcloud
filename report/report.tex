...
\end{itemize}
\testbench{} then evaluates the cross product of all these configurations (the
instances, as defined in Section~\ref{sec:instances}) and reports on the
results. This corresponds to a complete testing of all the presented parameters
of the system.
